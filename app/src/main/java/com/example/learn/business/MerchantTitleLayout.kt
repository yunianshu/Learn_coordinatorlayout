...
import com.example.learn.databinding.MerchantTitleLayoutBinding
...
class MerchantTitleLayout(context: Context, attrs: AttributeSet?) : FrameLayout(context, attrs) {
    ...
    private var binding: MerchantTitleLayoutBinding

    init {
        binding  = DataBindingUtil.inflate(LayoutInflater.from(context),R.layout.merchant_title_layout,this,true)
    }
